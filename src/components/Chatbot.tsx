...
const getStaticResponse = (question: string): string => {
  ...
  if (lowerQuestion.includes("龙舟") || lowerQuestion.includes("dragon boat") || lowerQuestion.includes("boat festival")) {
  ...
  if (lowerQuestion.includes("中秋") || lowerQuestion.includes("mid-autumn") || lowerQuestion.includes("moon festival")) {
        ...
        <div className="mx-auto max-w-3xl space-y-4">
          {messages.map((message) => (
            ...
            >
              ...
              >
                <p className="text-sm leading-relaxed" style={{fontFamily: 'var(--font-poppins)'}}>{message.text}</p>
        ...
        <div className="mx-auto max-w-3xl space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            {(language === "en" ? [
              ...
              <button
                ...
                className="rounded-full border-2 border-red-400 bg-red-50 px-3 py-1 text-xs text-red-700 font-semibold transition-all hover:bg-red-100 hover:shadow-md"
                style={{fontFamily: 'var(--font-poppins)'}}
              >
                {suggestion}
              </button>
          ...
          <div className="flex gap-3">
            <input
              ...
              placeholder={language === "en" ? "Ask about Chinese New Year..." : "问于春节的问题..."}
              className="flex-1 rounded-lg border-2 border-red-400 bg-white px-4 py-3 text-sm text-gray-900 placeholder-red-600 transition-all focus:border-red-600 focus:outline-none focus:ring-2 focus:ring-red-300"
              style={{fontFamily: 'var(--font-poppins)'}}
            />
            <button
